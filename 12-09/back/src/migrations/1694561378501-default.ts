...
export class Default1694561378501 implements MigrationInterface {
    name = 'Default1694561378501'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bikes" ("id" SERIAL NOT NULL, "color" character varying(30) NOT NULL, "size" character varying(10) NOT NULL, "material" "public"."bikes_material_enum" NOT NULL, "gender" "public"."bikes_gender_enum" NOT NULL, "speedkit" character varying(10) NOT NULL, "rim" double precision NOT NULL, "suspension" boolean NOT NULL, "description" character varying(200) NOT NULL, "hourlyvalue" numeric(10,2) NOT NULL, "dailyvalue" numeric(10,2) NOT NULL, "latitude" double precision NOT NULL, "longitude" double precision NOT NULL, "idbrand" integer NOT NULL, "idcategory" integer NOT NULL, "iduser" integer NOT NULL, CONSTRAINT "PK_5237c1fcb162998a0d31e640814" PRIMARY KEY ("id"))`);
